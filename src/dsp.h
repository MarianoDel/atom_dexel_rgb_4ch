...
unsigned char MAFilter8_Byte (unsigned char, unsigned char *);
unsigned short MAFilter8 (unsigned short *);
unsigned short MAFilter32 (unsigned short, unsigned short *);
unsigned char MAFilter32_Byte (unsigned char, unsigned char *);
...
unsigned short MAFilter16 (unsigned short, unsigned short *);
